...
type ClientInterface interface {
	// DaprSubscribe request
	DaprSubscribe(ctx context.Context, reqEditors ...RequestEditorFn) (*http.Response, error)
	...
	// RejectCreate request with any body
	RejectCreateWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) DaprSubscribe(ctx context.Context, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewDaprSubscribeRequest(c.Server)
	if err != nil {
		return nil, err
	}
...
func (c *Client) RejectCreateWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewRejectCreateRequestWithBody(c.Server, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
// NewDaprSubscribeRequest generates requests for DaprSubscribe
func NewDaprSubscribeRequest(server string) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/dapr/subscribe")
	if operationPath[0] == '/' {
...
// NewRejectCreateRequestWithBody generates requests for RejectCreate with any type of body
func NewRejectCreateRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/payment/rejectCreate")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
type ClientWithResponsesInterface interface {
	// DaprSubscribe request
	DaprSubscribeWithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*DaprSubscribeResponse, error)
	...
	// RejectCreate request with any body
	RejectCreateWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*RejectCreateResponse, error)
...
type DaprSubscribeResponse struct {
	...
	JSON200      *[]DaprSubscribe
}

// Status returns HTTPResponse.Status
func (r DaprSubscribeResponse) Status() string {
...
func (r DaprSubscribeResponse) StatusCode() int {
	if r.HTTPResponse != nil {
...
type RejectCreateResponse struct {
	Body         []byte
	HTTPResponse *http.Response
}

// Status returns HTTPResponse.Status
func (r RejectCreateResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r RejectCreateResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
// DaprSubscribeWithResponse request returning *DaprSubscribeResponse
func (c *ClientWithResponses) DaprSubscribeWithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*DaprSubscribeResponse, error) {
	rsp, err := c.DaprSubscribe(ctx, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseDaprSubscribeResponse(rsp)
}
...
// RejectCreateWithBodyWithResponse request with arbitrary body returning *RejectCreateResponse
func (c *ClientWithResponses) RejectCreateWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*RejectCreateResponse, error) {
	rsp, err := c.RejectCreateWithBody(ctx, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseRejectCreateResponse(rsp)
}
...
// ParseDaprSubscribeResponse parses an HTTP response from a DaprSubscribeWithResponse call
func ParseDaprSubscribeResponse(rsp *http.Response) (*DaprSubscribeResponse, error) {
	...
	response := &DaprSubscribeResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
// ParseRejectCreateResponse parses an HTTP response from a RejectCreateWithResponse call
func ParseRejectCreateResponse(rsp *http.Response) (*RejectCreateResponse, error) {
	bodyBytes, err := ioutil.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
