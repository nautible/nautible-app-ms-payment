package jp.co.ogis_ri.nautible.app.payment.credit.outbound;
...
import jp.co.ogis_ri.nautible.app.payment.credit.domain.CreditRepository;

/**
 * クレジット決済MDKのモック
 */
@ApplicationScoped
public class MockCreditRepositoryImpl implements CreditRepository {
